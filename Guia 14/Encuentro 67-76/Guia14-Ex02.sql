...
SELECT *
FROM pedido
WHERE DATE_FORMAT(fecha_pedido, '%Y') = '2009'
...
representantes de ventas. */
SELECT c.nombre_cliente, CONCAT(e.nombre, ' ', e.apellido1, ' ', e.apellido2) AS nombre_representante, COUNT(c.nombre_cliente) AS num_pagos
FROM cliente c
INNER JOIN empleado e ON c.codigo_empleado_rep_ventas = e.codigo_empleado
INNER JOIN pago p ON c.codigo_cliente = p.codigo_cliente
GROUP BY c.nombre_cliente, nombre_representante;
...
SELECT c.nombre_cliente, CONCAT(e.nombre, ' ', e.apellido1, ' ', e.apellido2) AS nombre_representante, o.ciudad, COUNT(c.nombre_cliente) AS num_pagos
FROM cliente c
INNER JOIN empleado e ON c.codigo_empleado_rep_ventas = e.codigo_empleado
INNER JOIN pago p ON c.codigo_cliente = p.codigo_cliente
INNER JOIN oficina o ON e.codigo_oficina = o.codigo_oficina
GROUP BY c.nombre_cliente, nombre_representante, o.ciudad;
...
SELECT o.codigo_oficina, o.linea_direccion1, o.linea_direccion2, COUNT(c.codigo_cliente) AS num_clientes
FROM oficina o
...
GROUP BY o.codigo_oficina, o.linea_direccion1, o.linea_direccion2;
...
SELECT e2.codigo_empleado, CONCAT(e2.nombre, ' ', e2.apellido1, ' ', e2.apellido2) AS Empleado, e1.codigo_empleado AS codigo_jefe, CONCAT(e1.nombre, ' ', e1.apellido1, ' ', e1.apellido2) AS Jefe
FROM empleado e1
...
SELECT COUNT(c.nombre_cliente) AS num_pedidos, c.nombre_cliente, gp.gama
FROM cliente c
INNER JOIN pedido p ON c.codigo_cliente = p.codigo_cliente
